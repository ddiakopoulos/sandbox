...
void main()
{
    ...
    //v_refraction = normalize(refract(incident, v_normal, eta));
    //v_refraction = u_viewProj * vec4(v_position + vec3(0.5), 1);

    //vec3 v_reflection = normalize(reflect(incident, v_normal));
